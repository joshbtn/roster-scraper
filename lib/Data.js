...
var isRowCollection = Data.isRowCollection = function(colomn){
    var isARowCollection =  (typeof colomn.length !== 'undefined'
        && typeof colomn !== 'function' // See https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function/length
        && colomn.length !== null);
    return isARowCollection;
};
...
var getRowCount = Data.getRowCount = function(normalize2dArray, columnOffset) {
  ...
  if ( isRowCollection( normalize2dArray[columnOffset] ) ){
