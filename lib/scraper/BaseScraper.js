...
BaseScraper.prototype.setData = function(){
    return data;
}

BaseScraper.prototype.getData = function(){
    return data;
}
...
var scrapeHtml = BaseScraper.scrapeHtml = BaseScraper.prototype.scrapeHtml = function(html, selectors){
